...
class PinResetNewController extends IOController {
  final String phone;
  final String token;

  PinResetNewController({
    required this.phone,
    required this.token,
  });

  final titleText = 'Нууц үг сэргээх';
  final otpText = 'Та шинэ гүйлгээний нууц үгээ оруулна уу';
  ...
  Future changePin() async {
    ...
    final response = await CustomerApi().resetPin(
      token: token,
      pin: otpField.value,
    );
